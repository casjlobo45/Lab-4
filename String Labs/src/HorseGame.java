 ...
 * Carden Reichert
 * 
 * Four methods need to be implemented in this class:
...
public class HorseGame {
    ...
    private void initializeBlankString( String word ){
    	...
    	revealedLetters = new StringBuilder();
    ...
    private void printWithSpaces(){
       ...
       char[] str = revealedLetters.toString().toCharArray();
        for (char c : str){
    ...
    private boolean checkGuess(){
        ...
        // compare revealedLetters to secretWord for equality.
    		String guess = revealedLetters.toString();
    	if (secretWord.compareToIgnoreCase(guess)){
