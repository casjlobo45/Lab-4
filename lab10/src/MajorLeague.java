 ...
 * MajorLeagueSolution.java
 * Carden Reichert
 *
 * This program reads in data on national league baseball teams which
 * lists their names, wins and losses in that order.  The data is read from
 * a text file and then prints out the team names along with their win
 * percentages.
 *
 * Adapted from mlb.c.
 *
...
public class MajorLeague {
    ...
    static final String NO_FILE = "File not found.  Please be sure " +
            "that the input file mlb_nl_2011.txt is in the working directory.";

    public static void main( String[] args ){

        /* Name of the input file */
        String fileName = "mlb_nl_2011.txt";
